...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        resultado_txt_a = str(resultado_numero_a)

        operador_b_txt = self.txt_operador_b.get()
        operador_b_int = int(operador_b_txt)
        resultado_numero_b = operador_b_int
        resultado_txt_b = str(resultado_numero_b)

        mensaje ="El resto de dividir " + str(resultado_numero_a) + " por " + str(resultado_numero_b) + " es: " + str(resultado_numero_a % resultado_numero_b)
